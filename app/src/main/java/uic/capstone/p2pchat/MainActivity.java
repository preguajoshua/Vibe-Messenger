...
import uic.capstone.vibemessenger.connect.NearConnect;
import uic.capstone.vibemessenger.discovery.NearDiscovery;
import uic.capstone.vibemessenger.model.Host;
import uic.capstone.p2pchat.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity{
    ...
    private static final long DISCOVERABLE_TIMEOUT_MILLIS = 10000;
            ...
            public void onClick(View v) {
                if (mDiscovering) {
                    ...
                    if (binding.handleEt.getText().length() > 0) {
                        ...
                        binding.handleEt.onEditorAction(EditorInfo.IME_ACTION_DONE);
                    } else {
                        Snackbar.make(binding.getRoot(), "Please type your name first",
                ...
                if (bytes != null) {
                    switch (new String(bytes)) {
                        ...
                        case MESSAGE_RESPONSE_DECLINE_REQUEST:
                            new AlertDialog.Builder(MainActivity.this)
                                    .setMessage(sender.getName() + " declined the request")
...
//        binding.participantsRv.setVisibility(View.GONE);
    ...
    private void startDiscovery() {
        ...
        mDiscoveryInProgressSnackbar = Snackbar.make(binding.getRoot(), "This will take 10 seconds to search for available device",
